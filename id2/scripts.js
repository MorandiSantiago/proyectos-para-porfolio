...
transform: scale(1) rotate(0deg);
    ...
    example4: {
       ...
       <section class="site">
         ...
         <blockquote>
            <img src="http://d.gr-assets.com/authors/1397426898p5/203714.jpg" align="left" alt="Henry Ford">
            “I invented nothing new. I simply assembled the discoveries of other men behind whom were centuries of work. So it is with every new thing. Progress happens when all the factors that make for it are ready.”
            <br>― Henry Ford
         </blockquote>
       </section>`,
        css: `html, body { padding: 0; margin: 0; height: 100%; }
      body { font: 1em/1.5 "Lato", sans-serif; font-size: 1.3em; }
      header { height: 100vh; position: relative; overflow: hidden; background: url(https://unsplash.imgix.net/45/ZLSw0SXxThSrkXRIiCdT_DSC_0345.jpg?q=75&w=1080&h=1080&fit=max&fm=jpg&auto=format&s=857f07b76abac23a7fb7161cc7b12a46) center no-repeat; background-size: cover; }
      ...
      .site { padding: 20em 0; text-align: center; background-color: #efefef; font-size: 0.8em; color: #444; position: relative; }
...
margin: 0 .45vw;
    ...
    example7: {
        html: `<a href="https://www.mythrillfiction.com/the-dark-rider" alt="Mythrill" target="_blank">
<div class="card">
<div class="wrapper">
